                ...
                <div className="w-full bg-white rounded shadow-lg p-8 m-4 md:max-w-sm md:mx-auto">
                    ...
                    <form className="mb-4"onSubmit={handleSubmit(onSubmit)}>
                        <div className="mb-4 md:w-full">
                            ...
                            <input className="w-full border rounded  p-2 outline-none focus:shadow-outline"{...register("email", { min: 0})} type="email" name="email" id="email" placeholder="Email"required />
                        </div>
                        ...
                        <button className="mt-4 mb-5 bg-green-500 hover:bg-green-700 py-3 text-white uppercase text-sm font-semibold rounded w-full">Login</button>
