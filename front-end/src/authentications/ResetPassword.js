        ...
        <>
            <div className="h-screen lg:mt-5 w-full">
                <div className="w-full bg-white rounded shadow-lg p-8 m-4 md:max-w-sm md:mx-auto">
                    <span className="block w-full text-xl uppercase font-bold">Reset Password</span>
                    <form className="mb-4" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <button type="submit" className="mt-4 mb-5 bg-green-500 hover:bg-green-700 py-3 text-white uppercase text-sm font-semibold rounded w-full">Reset Password</button>
                    </form>
                </div>
            </div>
        </>
